...
public class PlayerManagement : MonoBehaviour
{
    ...
    public int sizeIncrement; //Determins amount of size increase (Lower number = Bigger increase)
    ...
    {
        int[] info = new int[2]; //An array to get both the new score and the new size increment.
        info = upgradeManagement.IncreaseGrowth(score,sizeIncrement, growthMuliplier); //Calls "IncreaseGrowth" and contains the info in the array.
