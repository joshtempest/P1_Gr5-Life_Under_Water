...
/// <summary>
/// This script controls everything to do with the behavior of prey gameobjects.
/// </summary>
public class PreyBehavior : MonoBehaviour
{
    ...
    public float fleeRadius = 10f; // Sets the radius of how far the object is able to see.
